  ...
  { -- [group]        =
    ...
    { key             = "BASICS",
      ...
      tags            =
      {
        ...
        { name        = "rp:title",
          alias       = { "rp:title-short", "rp:honorific" },
        ...
        { name        = "rp:fulltitle",
          alias       = { "rp:title-full", "rp:title-long" },
