  ...
  { -- [group]        =
    ...
    { key             = "BASICS",
      ...
      tags            =
      {
        { name        = "rp:class",
          ...
          method      = function(u) return Get.text.class() end,
          size        = true,
        },
        { name        = "rp:race",
          ...
          alias       = { "rp:species" },
          method      = function(u) return Get.text.race() end,
          size        = true,
        },
        { name        = "rp:name",
          alias       = { "rp:fullname", "rp:name-full" },
          method      = function(u) return Get.text.name() end,
        ...
        { name        = "rp:firstname",
          ...
          method      = function(u) return Get.text.firstname() end,
          desc        = L["TAG_rp:firstname_DESC"],
          size        = true,
        },
        { name        = "rp:lastname",
          alias       = { "rp:name-last", },
          method      = function(u) return Get.text.lastname() end,
        ...
        { name        = "rp:me",
          ...
          method      = function(u) return Get.shared.me() end,
          size        = true,
        },
        { name        = "rp:name-known",
          label       = L["TAG_rp:name-known_LABEL"],
          desc        = L["TAG_rp:name-known_DESC"],
          method      = function(u) return Get.text.knownName() end,
          size        = true,
        },
        { name        = "rp:nick",
          alias       = { "rp:nickname" },
        ...
        { name        = "rp:title",
          ...
          method      = function(u) return Get.text.title() end,
        ...
        { name        = "rp:fulltitle",
          ...
          method      = function(u) return Get.text.fulltitle() end,
    ...
    { key             = "APPEARANCE",
      ...
      { { name        = "rp:body",
        ...
        { name        = "rp:eyes",
          ...
          method      = function(u) return Get.text.eyes() end,
          size        = true,
        },
        { name        = "rp:hair",
        ...
        { name        = "rp:height",
          ...
          method      = function(u) return Get.text.height() end,
          size        = true,
        },
        { name        = "rp:markings",
        ...
        { name        = "rp:sizebuff",
          ...
          method      = function(u) return Get.shared.sizebuff() end,
        },
        { name        = "rp:tattoos",
        ...
        { name        = "rp:weight",
          ...
          method      = function(u) return Get.text.weight() end,
          size        = true,
        },
    ...
    { key             = "COLORS",
      ...
      { { name        = "rp:color",
          ...
          method      = function(u) return Get.color.name() end,
          desc        = L["TAG_rp:color_DESC"],
          color       = true,
        },
        { name        = "rp:eyecolor",
          desc        = L["TAG_rp:eyecolor_DESC"],
          method      = function(u) return Get.color.eye() end,
          color       = true,
        },
        { name        = "rp:friendcolor",
          desc        = L["TAG_rp:friendcolor_DESC"] ,
          method      = function(u) return Get.shared.friendColor() end,
          extraEvents = "FRIENDLIST_UPDATE BN_FRIEND_INFO_CHANGED IGNORELIST_UPDATE",
          color       = true,
        },
        { name        = "rp:gendercolor",
          alias       = { "rp:sexcolor" },
          method      = function(u) return Get.color.gender() end,
          desc        = L["TAG_rp:gendercolor_DESC"],
          color       = true,
        },
        { name        = "rp:guildcolor",
          desc        = L["TAG_rp:guildcolor_DESC"] ,
          method      = function(u) return Get.shared.guildColor() end,
          extraEvents = "PLAYER_GUILD_UPDATE GUILD_ROSTER_UPDATE",
          color       = true,
        },
        { name        = "rp:guildstatuscolor",
          desc        = L["TAG_rp:guildstatuscolor_DESC"],
          method      = function(u) return Get.color.guildstatus() end,
          color       = true,
        },
        { name        = "rp:mecolor",
          alias       = { "rp:mycolor" },
          desc        = L["TAG_rp:mecolor_DESC"],
          method      = function(u) return Get.shared.meColor() end,
          color       = true,
        },
        { name        = "rp:partycolor",
          alias       = { "rp:raidcolor" },
          method      = function(u) return Get.shared.partyColor() end,
        ...
        { name        = "rp:relationcolor",
          ...
          method      = function(u) return Get.color.relation() end,
          color       = true,
        },
        { name        = "rp:statuscolor",
          desc        = L["TAG_rp:statuscolor_DESC"] ,
          method      = function(u) return Get.color.status() end,
          color       = true,
        },
        { name        = "nocolor",
        ...
        { name        = "rp:agecolor",
          ...
          method      = function(u) return Get.color.age() end,
          color       = true,
        },
        { name        = "rp:heightcolor",
          desc        = L["TAG_rp:heightcolor_DESC"] ,
          method      = function(u) return Get.color.height() end,
          color       = true,
        },
        { name        = "rp:weightcolor",
          desc        = L["TAG_rp:weightcolor_DESC"] ,
          method      = function(u) return Get.color.weight() end,
          color       = true,
        },
    ...
    { key             = "GENDER",
      ...
      { { name        = "rp:gender",
          ...
          method      = function(u) return Get.text.gender() end,
        ...
        { name        = "rp:pronouns",
          ...
          method      = function(u) return Get.text.pronouns() end,
          size        = true,
        },
    ...
    { key             = "HISTORY",
      ...
      { { name        = "rp:age",
          ...
          method      = function(u) return Get.text.age() end,
          size        = true,
        },
        { name        = "rp:years",
          label       = L["TAG_rp:years_LABEL"],
          desc        = L["TAG_rp:years_DESC"],
          method      = function(u) return Get.text.years() end,
        },
        { name        = "rp:years-old",
        ...
        { name        = "rp:birthplace",
          ...
          method      = function(u) return Get.text.birthplace() end,
          size        = true,
        },
      }, -- tags
    }, -- history
    ...
    { key             = "ICONS",
      ...
      { 
        ...
        { name        = "rp:relationicon",
          ...
          method      = function(u) return Get.icon.relation() end,
          icon        = true,
        },
        --]]
        { name        = "rp:sizebufficon",
          ...
          method      = function(u) return Get.shared.sizebuffIcon() end,
          extraEvents = "UNIT_AURA",
          icon        = true,
        },
        ...
        { name        = "rp:glance-icons",
          ...
          method      = function(u) return Get.icon.glances() end,
          icon        = true,
        },
        --]]
    ...
    { key             = "PROFILE",
      ...
      { { name        = "rp:profilesize",
        ...
        { name        = "rp:relation",
          ...
          method      = function(u) return Get.text.relation() end,
        },
        { name        = "rp:relation-who",
          label       = L["TAG_rp:relation-who_LABEL"],
          desc        = L["TAG_rp:relation-who_DESC"],
          method      = function(u) return Get.text.relwho() end,
        },
    ...
    { key             = "STATUS",
      ...
      { 
        ...
        { name        = "rp:curr",
          alias       = { "rp:currently" },
          method      = function(u) return Get.text.curr() end,
        ...
        { name        = "rp:info",
          alias       = { "rp:oocinfo", },
          method      = function(u) return Get.text.info() end,
    ...
    { key             = "SOCIAL",
      ...
      { { name        = "rp:alignment",
        ...
        { name        = "rp:home",
          ...
          method      = function(u) return Get.text.home() end,
