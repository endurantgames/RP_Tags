...
function(self, event, ...)
  ...
  L["SIZE_XL"]               = "XL";
  L["SIZE_XS"]               = "XS";
  L["SIZE_CODE_XS"]          = "xs|vs|extrasmall|extrashort|verysmall|veryshort|tiny";
  L["SIZE_CODE_S"]           = "s|small|short";
  L["SIZE_CODE_M"]           = "m|medium|regular|normal|average";
  L["SIZE_CODE_L"]           = "l|large|long|big";
  L["SIZE_CODE_XL"]          = "xl|extralarge|extralong|extrabig|verylarge|verylong|verybig|huge";
  L["SIZE_CODE_NOLIMIT"]     = "u|unlimited|nolimit|limitless|infinity|infinite";
  L["STYLE_BATTLE_0"]        = "";
  ...
  L["TAG_GROUP_COLORS_HELP"]                = "All color tags change the text color until the end of the current tag set, or another color tag is used. Many of the colors can be changed in [settings](opt://colors). [Relative colors](opt://colors/comparison) are based on your own values compared to the unit's values.";
  ...
  L["TAG_rp:glance-1-full_DESC"]            = "Glance Icon, Title, and Text";
  L["TAG_rp:glance-1-icon_DESC"]            = "Glance Icon 1";
  L["TAG_rp:glance-1-text_DESC"]            = "Glance Text 1";
  L["TAG_rp:glance-1_DESC"]                 = "Glance Title 1";
  L["TAG_rp:glance-2-full_DESC"]            = "Glance 2 Icon, Title, and Text";
  L["TAG_rp:glance-2-icon_DESC"]            = "Glance Icon 2";
  L["TAG_rp:glance-2-text_DESC"]            = "Glance Text 2";
  L["TAG_rp:glance-2_DESC"]                 = "Glance Text 2";
  L["TAG_rp:glance-3-full_DESC"]            = "Glance 3 Icon, Title, and Text";
  L["TAG_rp:glance-3-icon_DESC"]            = "Glance Icon 3";
  L["TAG_rp:glance-3-text_DESC"]            = "Glance Text 3";
  L["TAG_rp:glance-3_DESC"]                 = "Glance Title 3";
  L["TAG_rp:glance-4-full_DESC"]            = "Glance 4 Icon, Title, and Text";
  L["TAG_rp:glance-4-icon_DESC"]            = "Glance Icon 4";
  L["TAG_rp:glance-4-text_DESC"]            = "Glance Text 4";
  L["TAG_rp:glance-4_DESC"]                 = "Glance Title 4";
  L["TAG_rp:glance-5-full_DESC"]            = "Glance 5 Icon, Title, and Text";
  L["TAG_rp:glance-5-icon_DESC"]            = "Glance Icon 5";
  L["TAG_rp:glance-5-text_DESC"]            = "Glance Text 5";
  L["TAG_rp:glance-5_DESC"]                 = "Glance Title 5";
  ...
  L["TAG_rp:note-1-icon_DESC"]              = "Note Keyword 1 Icon";
  L["TAG_rp:note-1_DESC"]                   = "Note Keyword 1";
  L["TAG_rp:note-1_LABEL"]                  = "Note 1";
  L["TAG_rp:note-2-icon_DESC"]              = "Note Keyword 2 Icon";
  L["TAG_rp:note-2_DESC"]                   = "Note Keyword 2";
  L["TAG_rp:note-2_LABEL"]                  = "Note 2";
  L["TAG_rp:note-3-icon_DESC"]              = "Note Keyword 3 Icon";
  L["TAG_rp:note-3_DESC"]                   = "Note Keyword 3";
  ...
  L["TAG_rp:style-death-icon_DESC"]         = "Accept Character Death";
  L["TAG_rp:style-death-long_DESC"]         = "Accept Character Death";
  L["TAG_rp:style-death-long_LABEL"]        = "Accept Character Death";
  L["TAG_rp:style-death_DESC"]              = "Accept Character Death";
  L["TAG_rp:style-death_LABEL"]             = "Death";
  L["TAG_rp:style-guild-icon_DESC"]         = "Guild Membership IC/OOC Icon";
  ...
  L["TAG_rp:style-ic-icon_DESC"]            = "IC Frequency Icon";
