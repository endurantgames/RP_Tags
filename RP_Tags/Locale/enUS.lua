...
function(self, event, ...)
  ...
  L["CONFIG_COLOR_ME"]                   = "'Me'";
  L["CONFIG_COLOR_ME_TT"]                = "The color for yourself, when you use the [rp:me], [rp:mecolor], or [rp:target-me] tags.";
  ...
  L["CONFIG_ME"]                         = "'Me' value (i.e., your name)";
  L["CONFIG_ME_TT"]                      = "The name displayed when you use the [rp:me] or [rp:target-me] tags.";
  ...
  L["TAG_rp:me_DESC"]                       = "Me (i.e., you)";
  L["TAG_rp:me_LABEL"]                      = "Me: ";
  L["TAG_rp:mecolor_DESC"]                  = "'Me' Color";
  ...
  L["TAG_rp:target-gender_DESC"]            = "Target's Gender";
  L["TAG_rp:target-gender_LABEL"]           = "Target's Gender";
  L["TAG_rp:target-gendercolor_DESC"]       = "Target's Gender Color";
  L["TAG_rp:target-gendericon_DESC"]        = "Target's Gender Icon";
  L["TAG_rp:target-icon_DESC"]              = "Target's Character Icon";
  L["TAG_rp:target-me_DESC"]                = "Target, if Me";
  L["TAG_rp:target-me_LABEL"]               = "Target:";
  L["TAG_rp:target-mecolor_DESC"]           = "Target's Color, if Me";
  L["TAG_rp:target-race_DESC"]              = "Target's Race";
  L["TAG_rp:target-race_LABEL"]             = "Target's Race";
  L["TAG_rp:target-status_DESC"]            = "Target's Status";
  L["TAG_rp:target-statuscolor_DESC"]       = "Target's Status Color";
  L["TAG_rp:target-statusicon_DESC"]        = "Target's Status Icon";
  L["TAG_rp:target-title_DESC"]             = "Target's Title";
  L["TAG_rp:target-title_LABEL"]            = "Target's Title";
  L["TAG_rp:target_DESC"]                   = "Target's Name";
