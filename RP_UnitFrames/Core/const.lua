...
function(self, event, ...)
  ...
  { frames            = "opt://RPUF_Main",
    ...
    panel_icon1       = "opt://RPUF_Panels/icon1Panel",
    panel_icon2       = "opt://RPUF_Panels/icon2Panel",
    panel_icon3       = "opt://RPUF_Panels/icon3Panel",
    panel_icon4       = "opt://RPUF_Panels/icon4Panel",
    panel_icon5       = "opt://RPUF_Panels/icon5Panel",
    panel_icon6       = "opt://RPUF_Panels/icon6Panel",
