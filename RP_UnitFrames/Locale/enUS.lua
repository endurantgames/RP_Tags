...
function(self, event, ...)
  ...
  { 
    ...
    CONFIG_INFOPANEL_FONTNAME      = PANEL_FONTNAME,
    CONFIG_INFOPANEL_FONTNAME_TT   = PANEL_FONTNAME_TT,
    CONFIG_INFOPANEL_FONTSIZE      = PANEL_FONTSIZE,
    CONFIG_INFOPANEL_FONTSIZE_TT   = PANEL_FONTSIZE_TT,
    ...
    CONFIG_NAMEPANEL_FONTNAME      = PANEL_FONTNAME,
    CONFIG_NAMEPANEL_FONTNAME_TT   = PANEL_FONTNAME_TT,
    CONFIG_NAMEPANEL_FONTSIZE      = PANEL_FONTSIZE,
    CONFIG_NAMEPANEL_FONTSIZE_TT   = PANEL_FONTSIZE_TT,
    ...
    CONFIG_STATUSPANEL_FONTNAME      = PANEL_FONTNAME,
  ...
  L["CONFIG_STATUSPANEL"                ] = "Status Bar Panel";
  L["CONFIG_STATUSPANEL_TT"             ] = "Set the tags for the status bar panel. You don't have to use status tags.";
  L["CONFIG_STATUS_TOOLTIP"             ] = "Status Bar Panel Tooltip";
  L["CONFIG_STATUS_TOOLTIP_TT"          ] = "Set the tags for the status bar panel tooltip.";
  L["CONFIG_UNLOCK_FRAMES"              ] = "Unlock Frames";
  L["CONFIG_UNLOCK_FRAMES_TT"           ] = "Unlock all frames so that they can be moved around.";
    -- --- editor settings
