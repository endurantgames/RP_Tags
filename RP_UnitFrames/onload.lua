...
function(self, event, ...)
  ...
  local TagEdit = CreateFrame("frame", "RPTAGS_TagEdit", UIParent, "BasicFrameTemplate");
        ...
        TagEdit:WaitUntil("OnDragStart", TagEdit.StartMoving)
        TagEdit:WaitUntil("OnDragStop", TagEdit.StopMovingOrSizing)
        TagEdit:SetToplevel(true);
        TagEdit:SetUserPlaced(true);
        TagEdit:SetFrameStrata("DIALOG");
        TagEdit:WaitUntil("OnShow", RPTAGS.utils.rpuf.updateTagEdit);
  ...
  do  for i, buttonData in ipairs(row)
      do  local title, value, width = unpack(buttonData);
          ...
          button:WaitUntil("OnClick", function(self) TagEdit.textbox:Insert(self.value) end);
  ...
  local moretagsButton = CreateFrame("button", "RPTAGS_TagEdit_moretagsButton", contentPane, "UIPanelButtonTemplate");
        ...
        moretagsButton:WaitUntil("OnClick", function() EasyMenu(dropDownData, dropDownFrame, moretagsButton, 75, 5, "not MENU") end);
  ...
  local textbox = CreateFrame("editbox", nil, textboxScroll, BackdropTemplateMixin and "BackdropTemplate");
        ...
        textbox:WaitUntil("OnEscapePressed", function(self) self:ClearFocus() end);
        textbox:WaitUntil("OnTabPressed", function(self) self:ClearFocus() end);
        textbox:SetCursorPosition(0)
        textbox:SetJustifyH("LEFT")
        textbox:SetJustifyV("TOP")
        textbox:WaitUntil("OnShow", function(self) self:SetFocus() end);
  ...
  local revertButton = CreateFrame("button", nil, contentPane, "UIPanelButtonTemplate");
        ...
        revertButton:WaitUntil("OnClick", function(self) TagEdit.textbox:SetText(Config.get(TagEdit.setting)); end);
  ...
  local defaultButton = CreateFrame("button", nil, contentPane, "UIPanelButtonTemplate");
        ...
        defaultButton:WaitUntil("OnClick", function(self) TagEdit.textbox:SetText(Config.default(TagEdit.setting)); end);
  ...
  local cancelButton = CreateFrame("button", nil, contentPane, "UIPanelButtonTemplate");
        ...
        cancelButton:WaitUntil("OnClick", function(self) TagEdit.setting = nil; TagEdit.draft = nil; TagEdit:Hide(); end);
  ...
  local function RPUF_Style(self, unit)
    ...
    local framewidth, frameheight = RPTAGS.utils.rpuf.frame.size(layout);
          ...
          self:WaitUntil('OnEnter', UnitFrame_OnEnter);
          self:WaitUntil('OnLeave', UnitFrame_OnLeave);
    ...
    local NameTooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          NamePanel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          NamePanel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          NamePanel.source = "NAMEPANEL";
          NamePanel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local InfoTooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          InfoPanel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          InfoPanel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          InfoPanel.source = "INFOPANEL";
          InfoPanel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local DetailsTooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          DetailsPanel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          DetailsPanel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          DetailsPanel.source = "DETAILPANEL";
          DetailsPanel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local PortraitTooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Portrait:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Portrait:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Portrait:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
--           local portraitEvent;
...
--           Portrait:WaitUntil("OnEvent", function(content, event) if event == content.portraitEvent then RPTAGS.utils.rpuf.frame.portraitStyle(content:GetParent()) end; end); -- ##
    ...
    local Icon_1Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_1Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_1Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_1Panel.source = "ICON_1";
          Icon_1Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local Icon_2Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_2Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_2Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_2Panel.source = "ICON_2";
          Icon_2Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local Icon_3Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_3Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_3Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_3Panel.source = "ICON_3";
          Icon_3Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local Icon_4Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_4Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_4Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_4Panel.source = "ICON_4";
          Icon_4Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local Icon_5Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_5Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_5Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_5Panel.source = "ICON_5";
          Icon_5Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local Icon_6Tooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          Icon_6Panel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          Icon_6Panel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          Icon_6Panel.source = "ICON_6";
          Icon_6Panel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
          -- ---------------------------------------------------------------------------------------------------------
    ...
    local StatusBarTooltip       = Tooltip.panel:CreateFontString(nil, 'OVERLAY', 'GameFontNormal')
          ...
          StatusBarPanel:WaitUntil("OnEnter", RPUF_Panel_OnEnter);
          StatusBarPanel:WaitUntil("OnLeave", RPUF_Panel_OnLeave);
          StatusBarPanel.source = "STATUSPANEL";
          StatusBarPanel:WaitUntil("OnMouseUp", RPUF_Panel_OnMouseUp);
    ...
    local DragFrameLockButton = CreateFrame("button", nil, DragFrame, BackdropTemplateMixin and "BackdropTemplate")
          ...
          DragFrameLockButton:WaitUntil("OnClick", function(content) Config.set("LOCK_FRAMES", true); lockFrames() end);
    local DragFrameResetButton = CreateFrame("button", nil, DragFrame, BackdropTemplateMixin and "BackdropTemplate")
          ...
          DragFrameResetButton:WaitUntil("OnClick",
            function(content)
