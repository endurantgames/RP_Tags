...
function(self, event, ...)
  ...
  local function get_statusBar_top(self)
    return math.max(
        ...
        self:Gap(4) + self:Public("PanelGet", "Height", "name") + self:Public("PanelGet", "Height", "info") + self:ConfGet("DETAILHEIGHT")
      )
  end;
  ...
  local function get_frame_dimensions(self)
    return 
      ...
      math.max(
        self:Public("Gap", 8) + self:Public("ConfGet", "ICONWIDTH") * 6 + self:Public("ConfGet", "STATUSHEIGHT"),
        self:Public("Gap", 5) + self:Public("PanelGet", "Height", "name") + self:Public("ConfGet", "DETAILHEIGHT") + self:Public("ConfGet", "STATUSHEIGHT") + self:Public("PanelGet", "Height", "info"),
        self:Public("Gap", 2) + self:Public("ConfGet", "PORTWIDTH") * 1.5 + self:Public("ConfGet", "STATUSHEIGHT")
      )
  end;

  layout:Register_Panel_Method_Hash("GetPanelLeft",
    { [ "portrait"  ] = function(self) return self:Gap(2) + self:ConfGet("ICONWIDTH") end,
      ...
      [ "info"      ] = "name",
      [ "details"   ] = "name",
      [ "statusBar" ] = function(self) left = self:Public("ConfGet", "RPUF_BORDER_INSETS") return left; end,
    });
  ...
  layout:Register_Panel_Method_Hash("GetPanelWidth",
    { [ "portrait"  ] = function(self) return self:ConfGet("PORTWIDTH") end,
      ...
      [ "statusBar" ] = 
        function(self) 
          return self:Public("ConfGet", "PORTWIDTH") + self:Public("Gap", 4) + self:Public("ConfGet", "ICONWIDTH") 
                        + self:Public("ConfGet", "INFOWIDTH") - 2 * self:Public("ConfGet", "RPUF_BORDER_INSETS") 
          end,
    });
